...
export class Tab3Page implements OnInit{
  ...
  userName = "";
  email = "";
  profilePic = "https://disdukcapil.rejanglebongkab.go.id/v1/uploads/member/no-user-image.gif";
  avatar; 
    ...
    this.service.userDetail().subscribe(res => {
      if (res !== null){
        ...
        this.service.getProfilePic(this.email).subscribe((doc)=>{
          ...
          pic = doc.data();
          if(doc.data() === {}){
            this.profilePic = "https://disdukcapil.rejanglebongkab.go.id/v1/uploads/member/no-user-image.gif";
          }
          else{
